  ...
  return (
    <section className="py-20 md:py-32 px-6 bg-[#F7F4EE] dark:bg-[#1A1A18]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex gap-5 overflow-x-auto snap-x snap-mandatory md:pb-4 scrollbar-hide md:flex-row flex-col focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E58A0F]">
