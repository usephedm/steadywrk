...
export function WhatsAppFloat() {
  ...
  const handleDismiss = () => {
    setDismissed(true);
    sessionStorage.setItem('steadywrk-wa-dismissed', '1');
  };
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex items-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold px-4 py-3 rounded-full shadow-lg shadow-[#25D366]/20 transition-all duration-300 hover:shadow-[#25D366]/40 hover:scale-105"
