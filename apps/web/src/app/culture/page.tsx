              ...
              {[
                {
                  ...
                  items: ['Welcome ritual', 'Buddy pairing', 'Orientation Orbit modules'],
                  badge: 'Launched',
                },
                {
                  week: 'Week 2',
                  title: 'First Contact',
                  items: ['Shadow a lead', 'Ship first deliverable', 'Set 30/60/90 goals'],
                  badge: 'First Build',
                },
                {
                  week: 'Week 3',
                  title: 'Into Orbit',
                  items: ['Own a task', 'Demo day', 'Slack contributions'],
                  badge: 'Orbital',
                },
                {
                  week: 'Week 4',
                  title: 'Steady State',
                  items: ['Project review', 'Peer feedback', 'Reflection post'],
                  badge: 'Steady',
                },
              ].map((q) => (
                <div
