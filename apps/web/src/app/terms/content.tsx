...
const CONTENT = {
  ...
  ar: {
    ...
    sections: [
      {
        title: '1. القبول',
        content: 'باستخدام خدمات STEADYWRK، فإنك توافق على هذه الشروط. إذا لم توافق، يرجى عدم استخدام خدماتنا.',
      },
      {
        title: '2. الأهلية',
        content: 'يجب أن يكون عمرك 18 سنة أو أكثر. إذا كنت أقل من 18 سنة، يجب الحصول على موافقة ولي الأمر.',
      },
      {
        title: '3. الخدمات',
        content: 'توفر STEADYWRK منصة إطلاق مهني تعتمد على الذكاء الاصطناعي تشمل: برامج IGNITE و ORBIT و APEX، فرص عمل، محتوى تعليمي.',
      },
      {
      ...
      },
      {
        ...
        content: 'جميع المحتويات والعلامات التجارية مملوكة لشركة STEADYWRK LLC. لا يجوز نسخها أو توزيعها بدون إذن.',
      },
      {
        title: '6. التوظيف',
        content: 'العمل لدى STEADYWRK يخضع لقانون العمل الأردني. جميع الأعمال المنتجة خلال فترة التوظيف ملك لـ STEADYWRK.',
      },
      {
