          ...
          <div className="space-y-10 text-[#23211D]" style={{ fontFamily: 'var(--font-body)' }}>
            ...
            <section>
              ...
              <p className="text-[16px] leading-relaxed text-[#6E695F]">
                ...
                Supabase لقواعد البيانات، Resend للبريد الإلكتروني، PostHog للتحليلات. جميع مقدمي
                الخدمات ملزمون تعاقدياً بالتعامل مع بياناتك وفقاً للوائح حماية البيانات المعمول بها.
              </p>
            </section>
