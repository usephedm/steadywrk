  ...
  return (
    <>
      ...
      <main className="pt-16">
          ...
          <div className="max-w-5xl mx-auto">
            <BlurFade delay={0.1} direction="up">
              <nav className="text-[13px] text-[#B0B0AB] mb-8">
                ...
                <span className="text-[#23211D]">Careers</span>
              </nav>
              ...
              <p className="text-[#6E695F] text-[17px] leading-relaxed max-w-xl">
                Ship production AI systems from week one. Structured hiring, transparent criteria, 14-day timeline. We respond to every applicant within 48 hours.
              </p>
            </BlurFade>
          </div>
        </section>
        ...
        {/* Filters + Roles */}
        <section className="py-12 md:py-16 px-6 bg-[#F7F4EE]">
          <div className="max-w-5xl mx-auto">
            {/* Department filter */}
              ...
              {filteredRoles.map((role, i) => (
                <BlurFade key={role.slug} delay={0.05 + i * 0.06} inView>
                  <Link
                    ...
                    className={`flex items-center justify-between p-5 md:px-7 md:py-6 bg-white rounded-xl border shadow-[0_1px_2px_rgba(0,0,0,0.04)] group hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all duration-[180ms] ${
                      role.featured ? 'border-[#E58A0F]/20 ring-1 ring-[#E58A0F]/10' : 'border-[rgba(0,0,0,0.06)]'
                    }`}
                  >
                    <div>
                      <div className="flex items-center gap-2.5">
                        <h2 className="text-[17px] font-bold text-[#23211D] group-hover:text-[#E58A0F] transition-colors duration-[180ms]" style={{ fontFamily: 'var(--font-display)' }}>
                          {role.title}
                        </h2>
                        {role.featured && (
                      ...
                      <p className="text-[14px] text-[#6E695F] mt-3 max-w-xl leading-relaxed hidden md:block">{role.description}</p>
                    </div>
            ...
            {filteredRoles.length === 0 && (
              <div className="text-center py-16">
                <p className="text-[#6E695F] text-[16px]">No positions in this department right now. Check back soon.</p>
              </div>
            )}
          </div>
        </section>
