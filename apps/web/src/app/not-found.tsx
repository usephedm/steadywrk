  ...
  return (
    <main className="min-h-dvh flex items-center justify-center px-6" style={{ background: 'var(--color-bg)' }}>
      <div className="text-center max-w-md">
        <div className="text-6xl font-extrabold text-[var(--color-brand)] mb-4" style={{ fontFamily: 'var(--font-display)' }}>
          404
        </div>
        <h1 className="text-2xl font-bold text-[var(--color-graphite)] mb-3" style={{ fontFamily: 'var(--font-display)' }}>
          Page not found
        </h1>
