...
type EmployeeLevel = 'explorer' | 'contributor' | 'builder' | 'leader';
...
export function LeaderboardClient({ initialData }: { initialData: LeaderboardUser[] }) {
  ...
  const currentUser = initialData.find((e) => e.isCurrentUser);
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5">
                        ...
                        >
                          {person.level.charAt(0).toUpperCase() + person.level.slice(1)}
                        </span>
                      </td>
