...
export default function ScorecardPage() {
  ...
  const handleShare = async (platform: 'linkedin' | 'twitter') => {
    ...
    // 1. Log the share intent to our analytics loop (Tier 3 loop attribution)
    try {
  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        >
          {/* We display the actual dynamically generated OG image to the user so they see exactly what will be shared */}
          <Image
            src={ogImageUrl}
